...
function LeftNavBar(props) {
    return (
            <div className="left-part" Style="height: 100%;">
                <div className="yp_slide_menu" >
                    <span id="open_slide" onClick={props.expandNavClick} title="" data-toggle="tooltip" data-placement="bottom"  data-original-title="Expand">
