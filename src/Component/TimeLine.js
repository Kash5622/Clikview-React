    ...
    return (
        <>
            ...
            {searchOpen ? <MobileSearch /> : ""}
                <div id="main-container" className="main-content  container   container-full " data-logged="true">
                  ...
                  <i className="fa fa-camera js_x-uploader" data-handle="picture-user"></i>
                                        ...
                                        <div className="links-container">
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="https://clikview.com/@somac?page=videos" className="active" data-load="?link1=timeline&amp;id=somac&amp;page=videos">Videos</a></li>

                                                <li><a href="https://clikview.com/@somac?page=play-lists" className="" data-load="?link1=timeline&amp;id=somac&amp;page=play-lists">My Channels</a></li>


                                                <li>

                                                    <a href="https://clikview.com/@somac?page=shorts" className="" data-load="?link1=timeline&amp;id=somac&amp;page=shorts">Quick View</a>

                                                </li>


                                                <li><a href="https://clikview.com/@somac?page=liked-videos" className="" data-load="?link1=timeline&amp;id=somac&amp;page=liked-videos">Liked videos</a></li>


                                                <li>

                                                    <a href="https://clikview.com/@somac?page=activities" className="" data-load="?link1=timeline&amp;id=somac&amp;page=activities">
                                                        Timeline                </a>

                                                </li>


                                                <li><a href="https://clikview.com/@somac?page=about" className="" data-load="?link1=timeline&amp;id=somac&amp;page=about">About</a></li>



                                                <li><a href="https://clikview.com/@somac?page=article" className="" data-load="?link1=timeline&amp;id=somac&amp;page=article">
                                                    Article                </a></li>
